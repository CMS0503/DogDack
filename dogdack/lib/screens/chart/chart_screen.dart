...
//                                 for (int i = 0;
//                                     i < petSnapshot.data!.docs.length;
//                                     i++) {
//                                   print(chartController.chartSelectedName);
//                                   chartController.dogNames[petSnapshot
//                                           .data!.docs[i]
//                                           .get('name')
//                                           .toString()] =
//                                       petSnapshot.data!.docs[i].id.toString();
//                                   petSnapshot.data!.docs[i]
//                                       .get('name')
//                                       .toString();
//                                 }
//                                 if (!chartController.dogNames.keys
//                                     .toList()
//                                     .contains(chartController
//                                         .chartSelectedName.value))
//                                 {
//                                   if (chartController.dogNames.keys
//                                           .toList()
//                                           .length !=
...
//                                         chartController.dogNames.values
//                                             .toList()[0];
//                                     chartController.chartSelectedName.value =
//                                         chartController.dogNames.keys
//                                             .toList()[0];
//                                     chartController.goalTime = chartController
//                                         .dogGoal.values
//                                         .toList()[0];
//                                   };
//                                 }
...
//                                 // 등록한 강아지가 없으면
//                                 // chartController.getNames();
//                                 return (chartController.dogNames.keys
//                                         .toList()
//                                         .isEmpty)
//                                     // 강아지를 등록해달라는 dropbar
//                                     ? DropdownButton(
...
//                                                 .chartSelectedName.value,
//                                             items: chartController.dogNames.keys
//                                                 .toList()
//                                                 .map(
//                                               (value) {
...
//                                             ).toList(),
//                                             onChanged: (value) {
//                                               print(chartController
//                                                   .chartSelectedName.value);
//                                               chartController.chartSelectedName
//                                                   .value = value.toString();
//                                               chartController
//                                                       .chartSelectedId.value =
//                                                   chartController.dogNames[
//                                                       value.toString()];
//                                               if (!chartController
//                                                   .dogGoal.isNull) {
//                                                 chartController.goalTime =
//                                                     chartController.dogGoal[
//                                                         value.toString()];
//                                               }
//                                               change();
//                                               setChartData();
...
//                               }).toList(),
//                               onChanged: (value) {
//                                 chartController.selectedDateValue.value =
//                                     value!;
//                                 setState(() {});
//                               },
//                             )),
